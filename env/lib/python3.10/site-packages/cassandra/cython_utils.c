...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cassandra.cython_utils",
        "sources": [
            "cassandra/cython_utils.pyx"
        ]
    },
    "module_name": "cassandra.cython_utils"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cassandra__cython_utils
#define __PYX_HAVE_API__cassandra__cython_utils
/* Early includes */
#include <stdint.h>
#include <math.h>
#include <string.h>
...
/* Module declarations from "cassandra.cython_utils" */
static int __pyx_v_9cassandra_12cython_utils_is_little_endian;
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "cassandra.cython_utils"
extern int __pyx_module_is_main_cassandra__cython_utils;
int __pyx_module_is_main_cassandra__cython_utils = 0;

/* Implementation of "cassandra.cython_utils" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Duplicate_module_of_util_py_wit[] = "\nDuplicate module of util.py, with some accelerated functions\nused for deserialization.\n";
/* #### Code section: decls ### */
...
#define __pyx_n_u_DATETIME_EPOC __pyx_string_tab[2]
#define __pyx_n_u_cassandra_util __pyx_string_tab[3]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[4]
#define __pyx_n_u_datetime __pyx_string_tab[5]
#define __pyx_n_u_is_little_endian __pyx_string_tab[6]
...
#define __pyx_n_u_sys __pyx_string_tab[13]
#define __pyx_n_u_test __pyx_string_tab[14]
#define __pyx_kp_b_PyObject_double_datetime_from_ti __pyx_string_tab[15]
#define __pyx_int_1 __pyx_number_tab[0]
#define __pyx_int_1970 __pyx_number_tab[1]
...
static PyObject *__pyx_f_9cassandra_12cython_utils_datetime_from_timestamp(double __pyx_v_timestamp) {
  int __pyx_v_days;
  int64_t __pyx_v_days_in_seconds;
  int __pyx_v_seconds;
  double __pyx_v_tmp;
  double __pyx_v_micros_left;
...
*/
  __pyx_v_days = ((int)(__pyx_v_timestamp / 86400.0));

  /* "cassandra/cython_utils.pyx":49
 * cdef datetime_from_timestamp(double timestamp):
 *     cdef int days = <int> (timestamp / DAY_IN_SECONDS)
 *     cdef int64_t days_in_seconds = (<int64_t> days) * DAY_IN_SECONDS             # <<<<<<<<<<<<<<
 *     cdef int seconds = <int> (timestamp - days_in_seconds)
 *     cdef double tmp
*/
  __pyx_v_days_in_seconds = (((int64_t)__pyx_v_days) * 0x15180);

  /* "cassandra/cython_utils.pyx":50
 *     cdef int days = <int> (timestamp / DAY_IN_SECONDS)
 *     cdef int64_t days_in_seconds = (<int64_t> days) * DAY_IN_SECONDS
 *     cdef int seconds = <int> (timestamp - days_in_seconds)             # <<<<<<<<<<<<<<
 *     cdef double tmp
...
*/
  __pyx_v_seconds = ((int)(__pyx_v_timestamp - __pyx_v_days_in_seconds));

  /* "cassandra/cython_utils.pyx":52
 *     cdef int seconds = <int> (timestamp - days_in_seconds)
 *     cdef double tmp
 *     cdef double micros_left = modf(timestamp, &tmp) * 1000000.             # <<<<<<<<<<<<<<
...
*/
  __pyx_v_micros_left = (modf(__pyx_v_timestamp, (&__pyx_v_tmp)) * 1000000.);

  /* "cassandra/cython_utils.pyx":53
 *     cdef double tmp
 *     cdef double micros_left = modf(timestamp, &tmp) * 1000000.
 *     micros_left = modf(micros_left, &tmp)             # <<<<<<<<<<<<<<
 *     cdef int microseconds = <int> tmp
 * 
*/
  __pyx_v_micros_left = modf(__pyx_v_micros_left, (&__pyx_v_tmp));

  /* "cassandra/cython_utils.pyx":54
 *     cdef double micros_left = modf(timestamp, &tmp) * 1000000.
 *     micros_left = modf(micros_left, &tmp)
 *     cdef int microseconds = <int> tmp             # <<<<<<<<<<<<<<
 * 
...
*/
  __pyx_v_microseconds = ((int)__pyx_v_tmp);

  /* "cassandra/cython_utils.pyx":58
 *     # rounding to emulate fp math in delta_new
 *     cdef int x_odd
...
*/
  __pyx_v_tmp = round(__pyx_v_micros_left);

  /* "cassandra/cython_utils.pyx":59
 *     cdef int x_odd
 *     tmp = round(micros_left)
 *     if fabs(tmp - micros_left) == 0.5:             # <<<<<<<<<<<<<<
 *         x_odd = microseconds & 1
...
*/
  __pyx_t_1 = (fabs((__pyx_v_tmp - __pyx_v_micros_left)) == 0.5);
  if (__pyx_t_1) {

    /* "cassandra/cython_utils.pyx":60
 *     tmp = round(micros_left)
 *     if fabs(tmp - micros_left) == 0.5:
 *         x_odd = microseconds & 1             # <<<<<<<<<<<<<<
 *         tmp = 2.0 * round((micros_left + x_odd) * 0.5) - x_odd
...
*/
    __pyx_v_x_odd = (__pyx_v_microseconds & 1);

    /* "cassandra/cython_utils.pyx":61
 *     if fabs(tmp - micros_left) == 0.5:
 *         x_odd = microseconds & 1
 *         tmp = 2.0 * round((micros_left + x_odd) * 0.5) - x_odd             # <<<<<<<<<<<<<<
 *     microseconds += <int>tmp
 * 
*/
    __pyx_v_tmp = ((2.0 * round(((__pyx_v_micros_left + __pyx_v_x_odd) * 0.5))) - __pyx_v_x_odd);
...
*/
  __pyx_v_microseconds = (__pyx_v_microseconds + ((int)__pyx_v_tmp));

  /* "cassandra/cython_utils.pyx":64
 *     microseconds += <int>tmp
 * 
 *     return DATETIME_EPOC + timedelta_new(days, seconds, microseconds)             # <<<<<<<<<<<<<<
*/
  __Pyx_XDECREF(__pyx_r);
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_DATETIME_EPOC); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = ((PyObject *)__pyx_f_7cpython_8datetime_timedelta_new(__pyx_v_days, __pyx_v_seconds, __pyx_v_microseconds)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyNumber_Add(__pyx_t_2, __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 64, __pyx_L1_error)
...
*/
  ...
  __Pyx_AddTraceback("cassandra.cython_utils.datetime_from_timestamp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Function export code ---*/
  {
    ...
    __Pyx_GOTREF(__pyx_t_1);
    const char * __pyx_export_signature = __Pyx_PyBytes_AsString(__pyx_mstate_global->__pyx_kp_b_PyObject_double_datetime_from_ti);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (unlikely(!__pyx_export_signature)) __PYX_ERR(0, 1, __pyx_L1_error)
    #endif
    const char * __pyx_export_name = __pyx_export_signature + 19;
    void (*const __pyx_export_pointers[])(void) = {(void (*)(void))&__pyx_f_9cassandra_12cython_utils_datetime_from_timestamp, (void (*)(void)) NULL};
...
namespace {
  ...
  #endif
  {
      ...
      "cython_utils",
      __pyx_k_Duplicate_module_of_util_py_wit, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "cython_utils" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_cython_utils", 0);
  ...
  if (__pyx_module_is_main_cassandra__cython_utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cassandra.cython_utils")) {
      if (unlikely((PyDict_SetItemString(modules, "cassandra.cython_utils", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * 
*/
  __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_datetime, 0, 0, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_datetime, __pyx_t_2) < (0)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "cassandra/cython_utils.pyx":35
 * 
 * import datetime
 * import sys             # <<<<<<<<<<<<<<
 * 
...
*/
  __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_sys, 0, 0, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 35, __pyx_L1_error)
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_sys, __pyx_t_2) < (0)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "cassandra/cython_utils.pyx":38
 * 
 * cdef bint is_little_endian
...
*/
  {
    ...
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_cassandra_util, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 38, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
    ...
    __pyx_t_3 = 0; {
      ...
      switch (__pyx_t_3) {
        case 0:
        __pyx_t_5 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely((__pyx_t_5 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L1_error)
        __pyx_v_9cassandra_12cython_utils_is_little_endian = __pyx_t_5;
        break;
        default:;
      }
 ...
 * 
*/
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_datetime); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_datetime); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_mstate_global->__pyx_tuple[0], NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DATETIME_EPOC, __pyx_t_2) < (0)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "cassandra/cython_utils.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init cassandra.cython_utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init cassandra.cython_utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
 ...
 * 
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(3, __pyx_mstate_global->__pyx_int_1970, __pyx_mstate_global->__pyx_int_1, __pyx_mstate_global->__pyx_int_1); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 44, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{1},{13},{14},{18},{8},{16},{8},{10},{8},{12},{12},{10},{3},{8},{42}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (147 bytes) */
const char* const cstring = "x\3325\215;\016\3020\020D9\n%P\344\n\010A\n\n\224\024\351G\033{#-\330\316g\327\022\271=\016\210i\346\351i\244\251\316\267KWw\367G\215\272m\256\216T)\371\205\252l\022\\\220\304\220\004[\310qO\356\345\311\330$\262(\202\230\005\006'/\224\200HeW\022G\237\213.I\024\277=\255o8\232d\3439S\370ye\363<P\016\246\253\002\306j@\2736\375\223\235\355O\007?\346>\360q\367\177\304\260\214\021\033\251Q\234>wjG\177";
    ...
    #endif
    #else /* compression: none (184 bytes) */
const char* const bytes = ".?DATETIME_EPOCcassandra.utilcline_in_tracebackdatetimeis_little_endian__main____module____name____pyx_capi____qualname__setdefaultsys__test__PyObject *(double)\000datetime_from_timestamp";
    PyObject *data = NULL;
  ...
  }
  {
    ...
    int16_t const cint_constants_2[] = {1970};
    for (int i = 0; i < 2; i++) {
